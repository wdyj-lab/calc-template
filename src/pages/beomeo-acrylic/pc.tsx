...
const PcCalcPage = () => {
  ...
  const colorOptions = [
    ...
    { key: "transparency", value: "transparency", label: "PC투명" },
    { key: "black", value: "black", label: "PC흑백" },
    {
      key: "gwang",
      value: "gwang",
      label: "광확산PC",
  ...
  const selectedThickness = () => {
    switch (watch("color")) {
      ...
      case "transparency":
        return thicknessOptions.filter(
          (option) =>
            option.key === "none" || option.key === "3t" || option.key === "5t"
        );
      case "black":
        return thicknessOptions.filter(
          (option) =>
  ...
  const selectedManufacture = () => {
    switch (watch("color")) {
      ...
      case "black":
        return manufactureOptions;
      case "gwang":
        return manufactureOptions.filter((option) => option.key !== "bulgwang");
      default:
        return manufactureOptions;
    }
  };
