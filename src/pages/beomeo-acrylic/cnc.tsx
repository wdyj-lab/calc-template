...
const CncCalcPage = () => {
  ...
  const applicationSpecResolver = yup.object().shape({
    edge: yup.string().matches(noneRegex, "가공 형태를 선택해주세요."),
    material: yup.string().matches(noneRegex, "재질을 선택해주세요."),
  ...
  const materialOptions = [
    { key: "none", value: "none", label: "재질" },
    { key: "pc", value: "pc", label: "PC" },
  ...
  const pcThicknessOptions = [
    { key: "none", value: "none", label: "두께" },
    { key: "1t", value: "0.0225", label: "1T" },
    { key: "2t", value: "0.0291", label: "2T" },
    { key: "3t", value: "0.045", label: "3T" },
    { key: "4t", value: "0.0566", label: "4T" },
    { key: "4.5t", value: "0.07", label: "4.5T" },
    { key: "5t", value: "0.075", label: "5T" },
    { key: "6t", value: "0.07", label: "6T" },
    { key: "8t", value: "0.1166", label: "8T" },
    { key: "10t", value: "0.1416", label: "10T" },
  ];
      ...
      <Calculator>
        <SelectOption>
          <DropdownV2
            ...
            options={edgeOptions}
            {...getSimpleProps({ key: "edge", setValue, watch, errors })}
          />
        </SelectOption>
        <SelectOption>
          <DropdownV2
          ...
          <ResultBox>
            ...
            <ResultMessage>
              ...
              <div>
                <p>
                  {
                    edgeOptions.find((option) => option.value === watch("edge"))
                      ?.label
                  }
                </p>
                <p>
